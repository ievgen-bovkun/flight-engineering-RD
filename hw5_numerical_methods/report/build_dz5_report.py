...
GITHUB_URL = "https://github.com/ievgen-bovkun/flight-engineering-RD/tree/codex/homework4-longitudinal-linearization"
...
def main() -> None:
    ...
    story.extend([
        ...
        Spacer(1, 0.1 * inch),
        Paragraph(f'<link href="{GITHUB_URL}">GitHub: codex/homework4-longitudinal-linearization</link>', s["cover_subtitle"]),
        PageBreak(),
    ])
