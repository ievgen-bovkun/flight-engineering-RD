...
GITHUB_URL = (
    "https://github.com/ievgen-bovkun/flight-engineering-RD/tree/main/homework4"
)
...
def main() -> None:
    ...
    story.extend(
        [
            ...
            Spacer(1, 0.12 * inch),
            Paragraph(f'<link href="{GITHUB_URL}">GitHub: main/homework4</link>', styles["cover_subtitle"]),
            PageBreak(),
        ]
    )
